    ...
    return (
        <div className='flex'>
          ...
          <div className=''>
            ...
            <Link href={route("reports.sales")} className="block border">Звіти про продажі</Link>
            <Link href={route("reports.activity")} className="block border">Активність користувачів</Link>
          </div>
